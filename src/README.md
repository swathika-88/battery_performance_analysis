...
The agent works with any CSV that has the required columns (see `data/README.md`). No code changes are needed. Simply pass the `--data` flag pointing to your file.
